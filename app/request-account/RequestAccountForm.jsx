...
export default function RequestAccountForm() {
  const [form, setForm] = useState({ requesterName: '', requesterEmail: '', requesterPhone: '', organization: '', message: '' });
    ...
    return (
      <div className="min-h-screen bg-zinc-950 text-zinc-200">
        <div className="max-w-lg mx-auto px-6 py-12 text-center">
          <h1 className="text-4xl font-extrabold text-white mb-2">Account request received</h1>
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200">
      <div className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-extrabold text-white mb-2">Request an Account</h1>
        <p className="text-zinc-400 mb-6">Tell us about you or your organization and we’ll create an admin account for you.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm text-zinc-400 mb-1">Organization (optional)</label>
            <input name="organization" value={form.organization} onChange={onChange} className="w-full rounded-md bg-zinc-800 text-white px-3 py-2 border border-zinc-700" />
          </div>
