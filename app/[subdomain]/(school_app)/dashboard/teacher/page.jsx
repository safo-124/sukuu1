  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {wardenHostel && subdomain && (
          <div
            role="link"
            tabIndex={0}
            onClick={() => router.push(`/${subdomain}/resources/hostel?hostelId=${wardenHostel.id}`)}
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); router.push(`/${subdomain}/resources/hostel?hostelId=${wardenHostel.id}`); } }}
            className={`${featureCardClasses} cursor-pointer`}
          >
        ...
        {!wardenHostel && subdomain && (
          <Link href={`/${subdomain}/resources/hostel`} className={`${featureCardClasses} cursor-pointer`}>
            <Users className="h-12 w-12 text-emerald-600 dark:text-emerald-400 mb-3" />
            <h2 className={`text-xl font-semibold ${titleTextClasses} mb-1`}>Hostels</h2>
            <p className={`text-sm ${descriptionTextClasses}`}>Browse and manage school hostels.</p>
          </Link>
        )}
        {subdomain && (
          <Link href={`/${subdomain}/academics/assignments`} className={`${featureCardClasses} cursor-pointer`}>
        ...
        {subdomain && (
          <Link href={`/${subdomain}/academics/grades`} className={`${featureCardClasses} cursor-pointer`}>
        ...
        {subdomain && (
          <Link href={`/${subdomain}/academics/timetable`} className={`${featureCardClasses} cursor-pointer`}>
        ...
        {subdomain && (
          <Link href={`/${subdomain}/teacher/students`} className={`${featureCardClasses} cursor-pointer`}>
        ...
        {subdomain && (
          <Link href={`/${subdomain}/academics/subjects`} className={`${featureCardClasses} cursor-pointer`}>
        ...
        {subdomain && (
          <Link href={`/${subdomain}/attendance/students`} className={`${featureCardClasses} cursor-pointer`}>
