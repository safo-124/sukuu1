...
class AttendancePage extends StatefulWidget {
  ...
  const AttendancePage({super.key, required this.studentId, required this.studentName});
...
class _AttendancePageState extends State<AttendancePage> {
  ...
  List<Map<String, dynamic>> get _filteredItems {
    ...
    return _items.where((e) => (e['status']?.toString() ?? '').toUpperCase() == _filter).toList();
  }
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _FilterChip(label: 'Present', selected: _filter == 'PRESENT', onTap: () => setState(() => _filter = 'PRESENT')),
                            _FilterChip(label: 'Absent', selected: _filter == 'ABSENT', onTap: () => setState(() => _filter = 'ABSENT')),
                            _FilterChip(label: 'Late', selected: _filter == 'LATE', onTap: () => setState(() => _filter = 'LATE')),
                            _FilterChip(label: 'Excused', selected: _filter == 'EXCUSED', onTap: () => setState(() => _filter = 'EXCUSED')),
                          ],
                        ),
                      ),
                      Expanded(
