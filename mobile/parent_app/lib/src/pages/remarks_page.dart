...
class RemarksPage extends StatefulWidget {
  ...
  const RemarksPage({super.key, required this.studentId, required this.studentName});
...
class _RemarksPageState extends State<RemarksPage> {
  ...
  List<Map<String, dynamic>> get _filteredItems {
    ...
    return _items.where((e) => (e['source']?.toString() ?? '').toUpperCase() == _filter).toList();
  }
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _FilterChip(label: 'Exams', selected: _filter == 'EXAM', onTap: () => setState(() => _filter = 'EXAM')),
                            _FilterChip(label: 'Assignments', selected: _filter == 'ASSIGNMENT', onTap: () => setState(() => _filter = 'ASSIGNMENT')),
                          ],
                        ),
                      ),
                      Expanded(
